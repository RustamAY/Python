...
wrongWagon = int(input('Введите номер вагона i: '))
rightWagon = int(input('Введите номер вагона j: '))
if wrongWagon == rightWagon:
    print('Без дополнительной информации это сделать невозможно')
else:
    print('Всего вагонов в электричке: ', wrongWagon+(rightWagon-1))