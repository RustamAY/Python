...
for i in range(bushes):
    blueberries = int(input())
    blueberry.append(blueberries)
print(blueberry, '- blueberies')
count = list()
for i in range(len(blueberry) - 1):
    count.append(blueberry[i - 1] + blueberry[i] + blueberry[i + 1])
count.append(blueberry[-2] + blueberry[-1] + blueberry[0])
print(count)
print(max(count))